...
window.addEventListener("wheel", (e) => {
    ...
    bool && (document.querySelector(`.section-${deltaY ? counter1 : counter2}`).style.
        left = `${deltaY ? "-100vw" : "0"}`)
})
...
document.querySelector(".grapes").addEventListener("mouseover", () => {
    document.querySelector(".section-3-wrapper").style.opacity = ".5"
})

document.querySelector(".grapes").addEventListener("mouseout", () => {
